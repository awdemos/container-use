...
```sh
mkdir -p ./.amazonq/rules && curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md > .amazonq/rules/container-use.md
```
...
```sh
curl --create-dirs -o .cursor/rules/container-use.mdc https://raw.githubusercontent.com/awdemos/container-use/main/rules/cursor.mdc
```
...
```sh
curl --create-dirs -o .windsurf/rules/container-use.mdc https://raw.githubusercontent.com/awdemos/container-use/main/rules/windsurf.mdc
```
...
```sh
curl --create-dirs -o .github/copilot-instructions.md https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md
```
...
```sh
curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md >> AGENTS.md
```
...
Save agent instructions to your project root:
```sh
curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md >> AGENT.md
```
...
Save agent instructions to your project root:
```sh
curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md >> CRUSH.md
```
...
```sh
curl --create-dirs -o .clinerules/container-use.md https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md
```
...
```sh
mkdir -p ~/.codex
curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md >> ~/.codex/AGENTS.md
```
...
```sh
mkdir -p ./.junie && curl https://raw.githubusercontent.com/awdemos/container-use/main/rules/agent.md >> .junie/guidelines.md
```
